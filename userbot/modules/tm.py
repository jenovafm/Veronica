# BASED FROM ULTROID PORTED FOR Kaisar USERBOT BY KEN KAN / @kenkanasw
# THANKS ULTROID
# DONT REMOVE THIS
# KEN KAN GANTENG
# @musikkugroup
...
async def _(event):
    chat = "@TempMailBot"
    Kaisar = await event.edit("Sedang Memprosess...")
    async with bot.conversation(chat) as conv:
        try:
            ...
            Kaisaruserbot = ((response).reply_markup.rows[2].buttons[0].url)
...
# KEN KAN Ganteng
# Ported For Kaisar Userbot From Ultroid
