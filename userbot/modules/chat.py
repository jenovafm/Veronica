...
async def kickme(leave):
    ...
    await leave.edit("`Veronica Assistant Telah Meninggalkan Grup ツ`")
...
async def mute_chat(mute_e):
    ...
    await mute_e.edit("`Ssshssh Veronica Telah Membisukan Obrolan!`")
    await sleep(2)
    await mute_e.delete()
    if BOTLOG:
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`Ini Adalah Grup/Channel Privasi Atau Veronica Dibanned Dari Sana`")
            return None
