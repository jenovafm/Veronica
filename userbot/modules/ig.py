...
# Copyright (C) 2021 KEN KAN / @kenkanasw By Kaisar Userbot
# All rights reserved.
# Keredit
# Licensed under the Raphielscape Public License, Version 1.d (the "License");
# you may not use this file except in compliance with the License.
# Kaisar Userbot - From Kaisar To Kaisar
...
async def insta(event):
    ...
    if not event.reply_to_msg_id:
        await event.edit("`[Info] Mohon Balas Ke Link Instagram`")
        return
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await event.edit("`K[Info] Mohon Buka Blokir` @SaveAsbot `Lalu Coba Lagi`")
            return
        if response.text.startswith("Forward"):
            ...
            await event.client.send_file(
                ...
                caption=f"**Download By @musikkugroup**",
            )
...
# By Kaisar - Userbot
# KEN KAN Gansssssss Mksh Sma Sma
# KEN KAN Gans
