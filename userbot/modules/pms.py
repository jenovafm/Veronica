...
DEF_UNAPPROVED_MSG = (
    ...
    "━━━━━━━━━━━━━━━━━━━━\n"
    f"__Hi, Saya adalah asisten di grup ini, jangan spam atau tau akibatnya. Tunggu {DEFAULTUSER} menerima pesan anda__\n"
    "┏━━━━━━━━━━━━━━━━━━━\n"
    "┣[• `Pesan Otomatis`\n"
    "┣[• `By VeronicaAssistant`\n"
    "┗━━━━━━━━━━━━━━━━━━━")
# =================================================================
        ...
        if not apprv and event.text != UNAPPROVED_MSG:
            ...
            if COUNT_PM[event.chat_id] > 5:
                await event.respond(
                    ...
                    "`Ke Room Chat Veronica Assistant ツ`"
                )
                ...
                try:
                    ...
                    if BOTLOG:
                        await event.client.send_message(
                            BOTLOG_CHATID,
                            "[Info] Terjadi Masalah Saat Menghitung Private Message, Mohon Restart Bot!",
                        )
...
async def add_pmsg(cust_msg):
    ...
    if not PM_AUTO_BAN:
        return await cust_msg.edit("**[Info] Anda Harus Menyetel** `PM_AUTO_BAN` **Ke** `True`")
    try:
    ...
    if event.is_private:
        if not pm_permit_sql.is_approved(chats.id):
            pm_permit_sql.approve(
                chats.id, "`JenovaFM Telah Mengirimi Anda Pesan 😯`")
            await borg.send_message(
                chats, "**Menerima Pesan!, Pengguna Terdeteksi Adalah Developer**"
            )
