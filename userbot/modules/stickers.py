...
KANGING_STR = [
    "Mengambil Sticker Ini Ke Pack VeronicaAssistant",
    "VeronicaAssistant Mengambil Sticker Ini Ke Pack",
]
...
async def kang(args):
    ...
    if photo:
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            "\nIni pack yang baru saja VeronicaAssistant buat!"
                            f"\nTekan [VeronicaAssistant Sticker](t.me/addstickers/{packname}) Untuk Melihat Sticker VeronicaAssistant",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack, Tekan** **[VeronicaAssistant Sticker](t.me/addstickers/{packname})** **Untuk Melihat Pack Anda**",
            parse_mode="md",
        )
