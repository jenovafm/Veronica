# Port By kenkanasw/KEN KAN For Kaisar Userbot From Ultroid, Thanks
# Based Plugins
...
async def ultiny(event):
    ...
    if not (reply and (reply.media)):
        await event.edit("`[Info] Mohon Balas Ke Sticker`")
        return
    xx = await event.edit("`Memproses Tiny....`")
    ik = await bot.download_media(reply)
    im1 = Image.open("VeronicaAssistant/Veronica_Assistant.png")
    if ik.endswith(".tgs"):
...
# Port By KEN KAN Ganteng/kenkanasw
# Kaisar - Userbot
